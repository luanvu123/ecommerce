                    ...
                    <table class="table axil-product-table axil-wishlist-table">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td class="product-thumbnail"><a href=""><img src="{{ asset('fontend') }}/images/products/product-01.png" alt="Digital Product"></a></td>
                            ...
                            <tr>
                                <td class="product-remove"><a href="#" class="remove-wishlist"><i class="fal fa-times"></i></a></td>
                                <td class="product-thumbnail"><a href=""><img src="{{ asset('fontend') }}/images/products/product-02.png" alt="Digital Product"></a></td>
                            ...
                            <tr>
                                <td class="product-remove"><a href="#" class="remove-wishlist"><i class="fal fa-times"></i></a></td>
                                <td class="product-thumbnail"><a href=""><img src="{{ asset('fontend') }}/images/products/product-03.png" alt="Digital Product"></a></td>
        ...
        <div class="cart-content-wrap">
            ...
            <div class="cart-body">
                <ul class="cart-item-list">
                    ...
                    <li class="cart-item">
                        <div class="item-img">
                            <a href=""><img src="{{ asset('fontend') }}/images/products/product-03.png" alt="Commodo Blown Lamp"></a>
                            <button class="close-btn"><i class="fas fa-times"></i></button>
                        </div>
                        <div class="item-content">
