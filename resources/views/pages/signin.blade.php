            ...
            <div class="row align-items-center">
                ...
                <div class="col-sm-8">
                    <div class="singin-header-btn">
                        <p>Not a member?</p>
                        <a href="{{ route('customer.signup') }}" class="axil-btn btn-bg-secondary sign-up-btn">Sign Up Now</a>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="axil-signin-form">
                ...
                <form action="{{ route('customer.login.submit') }}" method="POST" class="singin-form">
                    ...
                    <div class="form-group d-flex align-items-center justify-content-between">
                        ...
                        <a href="{{ route('customer.password.request') }}" class="forgot-btn">Forget password?</a>
                    </div>
                </form>
            </div>
        </div>
